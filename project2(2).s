...
main:
    # main() prolog
    addi sp, sp, -32  # Allocate 32 bytes (20-byte buffer + alignment)
    sw ra, 28(sp)     # Save return address at offset 28
    ...
    addi a0, sp, 8     # Load stack buffer address into a0
    call gets          # Read input into stack buffer
